...
Download-software -software_name "PowerToys" 	-url "https://github.com/microsoft/PowerToys/releases/download/v0.81.1/PowerToysUserSetup-0.81.1-x64.exe"	-file_type exe;
...
Download-software -software_name "winscp"		-url "https://winscp.net/download/WinSCP-6.1.2-Setup.exe"		-file_type exe;
